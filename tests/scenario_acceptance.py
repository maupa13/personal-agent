...
def main() -> int:
    ...
    app_js = "".join((CORE / "static/js/app" / name).read_text(encoding="utf-8") for name in ("app-state.js", "app-render.js", "app-runtime.js", "app-actions.js"))
    index = (CORE / "static/pages/index.html").read_text(encoding="utf-8")
    admin_js = "".join((CORE / "static/js/admin" / name).read_text(encoding="utf-8") for name in ("admin-core.js", "admin-extras.js"))
    admin_html = (CORE / "static/pages/admin.html").read_text(encoding="utf-8")
