...
def main() -> int:
    tmp = ROOT / "release-evidence" / "_tmp" / "scenario-acceptance"
    if tmp.exists():
    ...
    try:
        ...
        prefs = svc.set_preferences("u1", {"search_scope": "selected", "region": "Москва", "allowed_domains": ["cian.ru", "zakupki.gov.ru"], "excluded_domains": ["example.com"], "prefer_russian": True, "news_interests": ["Технологии", "Бизнес"]})
