...
def main() -> int:
    if sync_playwright is None:
        assert "result-card-grid" in fixtures.APP and "quick-reply" in fixtures.APP
        print("PAR_V080_ALPHA7_LIVE_RESULTS_BROWSER PASS: playwright-unavailable static-contract fallback", flush=True)
        return 0
