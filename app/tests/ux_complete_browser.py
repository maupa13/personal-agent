...
def main() -> int:
    if sync_playwright is None:
        assert "themeSelect" in fixtures.APP and "executionPolicy" in fixtures.APP
        print("PAR_V080_ALPHA5_UX_COMPLETE_BROWSER PASS: playwright-unavailable static-contract fallback", flush=True)
        return 0
