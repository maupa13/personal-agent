...
if 'function Wait-CodeWorker' not in ps or 'function Start-CodeWorkerOptional' not in ps or 'function Test-CodeInternalSmoke' not in ps or 'function Test-CodeLiveAcceptance' not in ps:
