...
def execute_job(job_id: str, language: str, code: str, timeout_seconds: int) -> None:
    ...
    try:
        ...
        os.chown(work_dir, 0, RUNNER_GID)
...
class Handler(BaseHTTPRequestHandler):
    server_version = 'PersonalAgentCodeWorker/0.7.4-local.4'
...
def main() -> int:
    ...
    print(f'[code-worker] starting version=0.7.4-local.4 ready={inventory.get("ready")} network=disabled socket={SOCKET_PATH}', flush=True)
