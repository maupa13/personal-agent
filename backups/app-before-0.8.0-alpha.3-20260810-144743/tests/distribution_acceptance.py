...
if "PA_CODE_WORKER_IMAGE']='personal-agent-code-worker:0.8.0-alpha.3'" not in runtime:
...
if manifest.get('version')!='0.8.0-alpha.3': errors.append('manifest version mismatch')
if errors:
