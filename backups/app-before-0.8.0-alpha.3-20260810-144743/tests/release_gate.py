...
evidence_dir = pathlib.Path(os.getenv("PA_EVIDENCE_DIR", root / "release-evidence" / "0.8.0-alpha.3-local"))
...
steps = [
    ...
    (["FND-BROWSER-OFFLINE-001", "FND-PRODUCT-SHELL-001", "FND-PRODUCT-SHELL-V2-001", "FND-CHAT-EXPORT-001", "FND-PRESET-001", "PRV-001", "PRV-005", "AUTH-003", "WEB-004", "WEB-006", "FILE-017", "CODE-012", "BILL-006", "BILL-011", "TASK-001", "TASK-003", "DEPLOY-006", "OBS-001"], "browser-user-journeys", [sys.executable, str(root / "tests" / "browser_journeys.py")]),
...
summary = {
    ...
    "deferred_not_applicable_to_alpha3": [
        ...
        {"test_id": "UX-009", "status": "NOT_IMPLEMENTED", "mandatory_from": "0.8.0-beta.1", "reason": "complete cross-surface state matrix is a pre-beta product quality gate"},
