...
class Handler(BaseHTTPRequestHandler):
    server_version = 'PersonalAgentCodeWorker/0.8.0-alpha.3'
...
def main() -> int:
    ...
    print(f'[code-worker] starting version=0.8.0-alpha.3 ready={inventory.get("ready")} network=disabled socket={SOCKET_PATH}', flush=True)
