...
class Handler(BaseHTTPRequestHandler):
    server_version = 'PersonalAgentCodeWorker/0.8.0-alpha.6'
...
def main() -> int:
    ...
    print(f'[code-worker] starting version=0.8.0-alpha.6 ready={inventory.get("ready")} network=disabled socket={SOCKET_PATH}', flush=True)
