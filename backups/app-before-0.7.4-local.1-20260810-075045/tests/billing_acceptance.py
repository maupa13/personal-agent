...
def main():
    ...
    try:
        ...
        print('PAR_V073_BILLING_ACCEPTANCE PASS: plans local-unlimited token-display remote-quota local-fallback byok-separation payment-adapter verified-webhook idempotency cancel-period-end admin-usage')
        return 0
    finally:
