# Observability — v0.7.3

v0.7.3 ships a deliberately lightweight built-in Admin monitoring view suitable for local machines and small VPS nodes. It is not presented as the final OpenTelemetry/Prometheus architecture required by MASTER-SPEC.
