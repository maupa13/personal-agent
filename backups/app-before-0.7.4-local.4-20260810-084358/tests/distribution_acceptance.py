...
if "PA_CODE_WORKER_IMAGE']='personal-agent-code-worker:0.7.4-local.3'" not in runtime:
...
if manifest.get('version')!='0.7.4-local.3': errors.append('manifest version mismatch')
if errors:
