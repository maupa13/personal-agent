...
def main():
    ...
    env['PA_VERSION']='0.7.4-local.3-test'
    ...
    try:
        ...
        print('PAR_V074_BILLING_ACCEPTANCE PASS: plans local-unlimited token-display remote-quota local-fallback byok-separation payment-adapter verified-webhook idempotency cancel-period-end admin-usage')
        return 0
    finally:
