...
if "PA_CODE_WORKER_IMAGE']='personal-agent-code-worker:0.8.0-alpha.7'" not in runtime:
...
for token,label in (("personal-agent-core:0.8.0-alpha.7",'Core'),("personal-agent-browser:0.8.0-alpha.7",'Browser'),("personal-agent-code-worker:0.8.0-alpha.7",'Code worker')):
...
if manifest.get('version')!='0.8.0-alpha.7': errors.append('manifest version mismatch')
if errors:
