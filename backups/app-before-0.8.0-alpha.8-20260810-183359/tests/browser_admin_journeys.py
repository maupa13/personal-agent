...
def main():
    ...
    with sync_playwright() as p:
        ...
        admin.get_by_role('button',name='Диагностика',exact=True).click();admin.locator('#refreshDiagnostics').click();expect(admin.locator('#adminDiagnostics')).to_contain_text('0.8.0-alpha.7')
        admin.close()
