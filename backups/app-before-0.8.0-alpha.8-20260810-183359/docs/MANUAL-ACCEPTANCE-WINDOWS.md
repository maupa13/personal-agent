# Personal Agent Rus v0.7.3 — Manual Acceptance Checklist
...
- архив `PersonalAgentRus-Windows.zip`;
...
# 1. Обновление до v0.7.3

Распаковать содержимое v0.7.3 **поверх текущей рабочей папки Personal Agent Rus** с заменой файлов.
...
Это один из главных новых ручных тестов v0.7.3.
...
2. `REPAIR.cmd`
3. открыть UI и подтвердить `v0.7.3`
