...
for token in ('/api/preferences/experience','/api/feedback','/api/admin/feedback','/api/admin/auth-status','openai_responses','/responses','choose_route_for_execution_policy','apply_response_preferences','peer.is_loopback'):
