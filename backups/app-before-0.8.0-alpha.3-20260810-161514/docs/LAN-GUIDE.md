...
Personal Agent имеет LAN foundation, но полный second-device acceptance для 0.8.0-alpha.5 остаётся внешним gate на реальном Windows reference PC и физическом мобильном устройстве.
