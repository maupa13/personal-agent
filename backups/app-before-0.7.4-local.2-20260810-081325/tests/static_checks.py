...
for token in ('SOCKET_GID','os.chmod(SOCKET_PATH, 0o660)','PRLIMIT_BIN','SETPRIV_BIN','--cpu=','--fsize=','--nofile=64:64','--nproc=64:64','--reuid=','--regid=','--clear-groups','start_new_session=True','terminate_process','powershell','javac','output_truncated'):
