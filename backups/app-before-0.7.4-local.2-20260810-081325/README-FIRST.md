# Personal Agent Rus 0.7.4-local.1 — quality local launch candidate
...
0.7.4-local.1 fixes Windows distribution/first-run UX. It is **not v1.0**. v1.0 is reserved for the mandatory MASTER-SPEC acceptance matrix, including remaining context/memory, full coding-agent, media, automation/connectors, public/server operations and the required reference Windows/VPS/payment/reboot/clean-machine gates.
