...
class Handler(SimpleHTTPRequestHandler):
    ...
    def _rewrite_static_page_path(self, path: str) -> bool:
        rewrites = {
            ...
            "/cookies/": "/pages/cookies.html",
            "/cookies.html": "/pages/cookies.html",
            "/disclaimer": "/pages/disclaimer.html",
            "/disclaimer/": "/pages/disclaimer.html",
            "/disclaimer.html": "/pages/disclaimer.html",
    ...
    def translate_path(self, path: str) -> str:
        ...
        if clean.startswith("/static/"):
            ...
            clean = clean.lstrip("/") or "pages/index.html"
        legacy_pages = {
            "account.html",
            "admin.html",
            "admin-guide.en.html",
        ...
        legacy_assets = {
            ...
            "admin-egress-proxy.js": "js/admin-egress-proxy.js",
            "favicon.ico": "assets/icons/favicon.ico",
            "favicon-32.png": "assets/icons/favicon-32.png",
            "apple-touch-icon.png": "assets/icons/apple-touch-icon.png",
            "favicon.svg": "assets/icons/favicon.svg",
        }
        if clean in legacy_assets:
            clean = legacy_assets[clean]
