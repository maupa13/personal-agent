...
const AUTH_I18N = {
  ru: {
    ...
    requestBalanceNoRemote:
      "Локальные модели без лимита. Платформенный remote-лимит пока не настроен.",
    requestBalanceExceeded:
      "Лимит удалённых запросов исчерпан. Смените режим выполнения, дождитесь обновления периода или выберите другой тариф.",
    ...
    billingManual:
      "Ручное пополнение работает через заявку администратору или промокод. Откройте YooMoney в новой вкладке, затем отправьте reference платежа для зачисления.",
    topupUnavailable:
      "Не удалось отправить заявку на пополнение. Проверьте сумму и reference платежа.",
    promoUnavailable:
      "Не удалось активировать промокод. Проверьте код или обратитесь к администратору.",
    themesUnavailable:
      "Каталог дополнительных тем пока пуст. Базовые темы доступны в настройках интерфейса.",
    ...
    emailUnverified:
      "Email ещё не подтверждён. Ссылка для подтверждения доступна на странице входа.",
    ...
    topupBlockedDetail:
      "Встроенная панель YooMoney может блокироваться браузером или провайдером. Откройте оплату в новой вкладке, затем отправьте reference платежа на этой странице.",
    topupOpenLink: "Открыть YooMoney в новой вкладке",
    topupStepsTitle: "Как пополнить баланс",
    topupStepsDetail:
      "1. Откройте YooMoney. 2. Выполните оплату. 3. Вернитесь на эту страницу и отправьте reference для ручного зачисления.",
    loginSupportNote:
      "Для восстановления доступа используйте ссылку «Забыли пароль?». Если письмо не пришло или нужен живой ответ, напишите на {support}.",
    registerTrustNote:
      "Указывайте реальный email: ссылка подтверждения и восстановление пароля работают через одноразовые ссылки с ограниченным сроком действия. По вопросам регистрации: {support}.",
    forgotLead:
      "Введите email аккаунта. Если восстановление доступно, система подготовит ссылку для смены пароля.",
    forgotLeadNoEmail:
      "Введите email аккаунта. Если восстановление доступно, письмо для сброса будет отправлено после настройки SMTP на сервере. Если доступ нужен срочно, напишите на {support}.",
    resetLead:
      "Укажите новый пароль для аккаунта. Ссылка действует ограниченное время.",
    verifyLead: "Проверяю ссылку подтверждения и состояние аккаунта.",
    verifyRequestLead:
      "Если ссылка подтверждения потеряна, можно подготовить новую.",
    ...
    emailDeliveryDisabled:
      "Почтовая отправка не настроена на сервере. Заполните SMTP в deploy/server/.env.vps и повторите запрос. Для ручной помощи: {support}.",
    emailDeliveryFailed:
      "Письмо не отправлено. Проверьте SMTP на сервере в deploy/server/.env.vps и запросите письмо повторно. Если проблема осталась, используйте {support}.",
    ...
    resetReady:
      "Если аккаунт существует и готов к восстановлению, ссылка подготовлена.",
    verifyReady:
      "Если аккаунт существует и ждёт подтверждения, ссылка подготовлена.",
    verifyPendingAdmin:
      "Email подтверждён. Аккаунт ещё ждёт активации администратором.",
    verifyDone: "Email подтверждён. Вход выполнен.",
    verifyRequestDone:
      "Если аккаунт существует и ждёт подтверждения, новая ссылка подготовлена.",
    resetDone: "Пароль обновлён. Вход выполнен.",
    registrationPendingVerify:
      "Аккаунт создан, но перед входом нужно подтвердить email.",
    registrationPendingApproval:
      "Регистрация создана. Ожидается одобрение администратора.",
    registrationPendingBoth:
      "Регистрация создана. Подтвердите email, затем дождитесь одобрения администратора.",
  },
  en: {
    ...
    requestBalanceNoRemote:
      "Local models are unlimited. Platform remote quota is not configured yet.",
    requestBalanceExceeded:
      "The remote quota is exhausted. Change execution mode, wait for renewal, or switch the plan.",
    usageTitle: "AI usage",
    usageLocal: "Local: {tokens} tokens",
    usageRemote: "Platform remote: {used} / {limit}",
    usageByok: "BYOK: {tokens} tokens",
    billingManual:
      "Manual top-up works via an administrator-confirmed request or a promo code. Open YooMoney in a new tab, then send the payment reference for reconciliation.",
    topupUnavailable:
      "The top-up request could not be sent. Check the amount and payment reference.",
    promoUnavailable:
      "The promo code could not be redeemed. Check the code or contact the administrator.",
    themesUnavailable:
      "The additional theme catalog is empty. Built-in themes are available in Settings.",
    ...
    emailUnverified:
      "Email is not verified yet. A verification link is available on the sign-in page.",
    ...
    topupBlockedDetail:
      "The embedded YooMoney panel may be blocked by the browser or the provider. Open YooMoney in a new tab, then send the payment reference on this page.",
    topupOpenLink: "Open YooMoney in a new tab",
    topupStepsTitle: "How to top up",
    topupStepsDetail:
      "1. Open YooMoney. 2. Complete the payment. 3. Return here and send the payment reference for reconciliation.",
    registerTrustNote:
      "Use a real email address: verification and password recovery use one-time links with a limited lifetime. Registration questions: {support}.",
    forgotLead:
      "Enter the account email. If recovery is available, a password reset email will be sent.",
    forgotLeadNoEmail:
      "Enter the account email. If recovery is available, the reset email will be sent after SMTP is configured on the server. For urgent help, contact {support}.",
    resetLead:
      "Set a new password for the account. The link is valid for a limited time.",
    verifyLead: "Checking the verification link and account state.",
    verifyRequestLead:
      "If the verification link was lost, you can prepare a new one.",
    ...
    emailDeliveryDisabled:
      "Email delivery is not configured on the server. Fill SMTP settings in deploy/server/.env.vps and request it again. For manual help, contact {support}.",
    emailDeliveryFailed:
      "The email was not sent. Check server SMTP in deploy/server/.env.vps and request it again. If it still fails, contact {support}.",
    ...
    resetReady:
      "If the account exists and can be recovered, the link is ready.",
    verifyReady:
      "If the account exists and is waiting for verification, the link is ready.",
    verifyPendingAdmin:
      "Email verified. The account is still waiting for administrator activation.",
    verifyDone: "Email verified. You are now signed in.",
    verifyRequestDone:
      "If the account exists and is waiting for verification, a new link is ready.",
    resetDone: "Password updated. You are now signed in.",
    registrationPendingVerify:
      "The account was created, but email verification is required before sign-in.",
    registrationPendingApproval:
      "Registration created. Waiting for administrator approval.",
    registrationPendingBoth:
      "Registration created. Verify the email, then wait for administrator approval.",
  },
};
...
function T() {
  return AUTH_I18N[authLang()];
}
function AT(ru, en) {
  return authLang() === "en" ? en : ru;
}
...
function supportEmail(state) {
  return String(
    state?.support_email ||
      window.__authSystemState?.support_email ||
      SUPPORT_EMAIL_DEFAULT,
  );
}
function authSecurity(state) {
  return state?.auth_security || window.__authSystemState?.auth_security || {};
}
function honeypotFieldName(state) {
  return String(authSecurity(state).honeypot_field || AUTH_HONEYPOT_DEFAULT);
}
function queryToken() {
  return new URLSearchParams(location.search).get("token") || "";
}
function authRuntimeProfile(state) {
  return String(state?.runtime_profile || "local").toLowerCase() === "server"
    ? "server"
    : "local";
}
function authEditionLabel(lang = authLang(), state = null) {
  const t = AUTH_I18N[lang];
  return authRuntimeProfile(state) === "server"
    ? t.editionServer
    : t.editionLocal;
}
...
function effectiveAuthTheme(value) {
  if (value === "system")
...
function setAuthTheme() {
  ...
  document
    ...
    ?.setAttribute(
      "content",
      AUTH_THEME_COLOR_MAP[theme] || AUTH_THEME_COLOR_MAP.dark,
    );
}
...
function ensureSupportLink(state) {
  ...
  const host =
    document.querySelector(".legal-links") ||
...
function authPayload(form, state, payload) {
  ...
  if (security.turnstile_enabled)
    out.captcha_token = form?.dataset.turnstileToken || "";
  return out;
}
...
function updateStaticProfileCopy() {
  const t = T();
  $("#balanceTitle") &&
    ($("#balanceTitle").textContent = t.requestBalanceTitle);
  $("#usageTitle") && ($("#usageTitle").textContent = t.usageTitle);
  $("#showTokensLabel") &&
    ($("#showTokensLabel").childNodes[
      $("#showTokensLabel").childNodes.length - 1
    ].textContent = ` ${t.showTokens}`);
  $("#topupIntro") && ($("#topupIntro").textContent = t.billingManual);
  $("#topupBlockedTitle") &&
    ($("#topupBlockedTitle").textContent = t.topupBlockedTitle);
  $("#topupBlockedDetail") &&
    ($("#topupBlockedDetail").textContent = t.topupBlockedDetail);
...
function applyAuthLanguage(lang = authLang(), state = null) {
  ...
  if (eyebrow)
    eyebrow.textContent =
      page === "account" ? (lang === "en" ? "PROFILE" : "ПРОФИЛЬ") : t.account;
  setLabel("#email", t.email);
  setLabel("#password", t.password);
  const remember = $("#rememberMe")?.closest("label");
  if (remember) {
    const txt = Array.from(remember.childNodes).find(
  ...
  for (const a of document.querySelectorAll(".auth-links a")) {
    ...
    else if (a.getAttribute("href") === "/register")
      a.textContent = t.newAccount;
    else if (a.getAttribute("href") === "/login")
      a.textContent = page === "register" ? t.hasAccount : t.backToLogin;
    else if (a.getAttribute("href") === "/forgot-password")
      a.textContent = t.forgotLink;
  }
  if ($("#logoutBtnUser")) $("#logoutBtnUser").textContent = t.logout;
  const support = supportEmail(state);
  if ($("#loginSupportNote"))
    $("#loginSupportNote").textContent = fill(t.loginSupportNote, { support });
  if ($("#registerTrustNote"))
    $("#registerTrustNote").textContent = fill(t.registerTrustNote, {
      support,
    });
  if ($("#forgotLead"))
    $("#forgotLead").textContent = fill(t.forgotLead, { support });
  if ($("#resetLead")) $("#resetLead").textContent = t.resetLead;
  if ($("#verifyLead"))
    $("#verifyLead").textContent = queryToken()
      ? t.verifyLead
      : t.verifyRequestLead;
  if ($("#recoveryLinkTitle"))
    $("#recoveryLinkTitle").textContent = t.recoveryLinkTitle;
  if ($("#recoveryLink")) $("#recoveryLink").textContent = t.openLink;
  if ($("#tokenState") && $("#tokenState").textContent.trim() === "")
    $("#tokenState").textContent = t.tokenChecking;
  if ($("#sessionSection h2")) $("#sessionSection h2").textContent = t.sessions;
  if ($("#revokeOtherSessions"))
    $("#revokeOtherSessions").textContent = t.otherSessions;
  document.title =
    (page === "login"
      ? t.login
      : page === "register"
...
async function loadConfig() {
  const [authState, systemState] = await Promise.allSettled([
    api("/api/auth/me"),
    api("/api/system"),
  ]);
  if (systemState.status === "fulfilled")
    window.__authSystemState = systemState.value || {};
  if (authState.status === "rejected") {
    if (authState.reason?.status === 401) {
      return {
        ...
        mode: "accounts",
        runtime_profile:
          systemState.status === "fulfilled"
            ? systemState.value.runtime_profile
            : "local",
        support_email:
          systemState.status === "fulfilled"
            ? systemState.value.support_email
            : SUPPORT_EMAIL_DEFAULT,
        auth_security:
          systemState.status === "fulfilled"
            ? systemState.value.auth_security || {}
            : {},
      };
    }
  ...
  if (systemState.status === "fulfilled") {
    if (systemState.value?.runtime_profile)
      state.runtime_profile = systemState.value.runtime_profile;
    if (systemState.value?.support_email)
      state.support_email = systemState.value.support_email;
    if (systemState.value?.auth_security)
      state.auth_security = systemState.value.auth_security;
  }
  return state;
}
...
function planName(plan) {
  ...
  return (
    { LIGHT: "Light", MEDIUM: "Medium", PRO: "Pro", ADMIN: "Admin" }[plan.id] ||
    plan.display_name
  );
}
...
function planDescription(plan) {
  if (plan.id === "ADMIN")
    return AT(
      "Администратор: коммерческих ограничений нет. Локальные и удалённые вызовы только учитываются в статистике.",
      "Administrator: no commercial limits. Local and remote calls are still measured in usage statistics.",
    );
  const remote =
    Number(plan.remote_token_limit || 0) > 0
      ? AT(
          `Remote API: до ${formatTokens(plan.remote_token_limit)} токенов/мес. по текущей настройке администратора.`,
          `Remote API: up to ${formatTokens(plan.remote_token_limit)} tokens/month under the current admin configuration.`,
        )
      : AT(
          "Platform-paid remote API по умолчанию отключён до настройки лимита администратором.",
          "Platform-paid remote API is disabled by default until an administrator configures a quota.",
        );
...
async function changePlan(planId) {
  ...
  try {
    ...
    state.textContent = result.free
      ? AT("Тариф изменён. Обновляю…", "Plan changed. Refreshing…")
      : AT("Платёж создан.", "Payment created.");
    ...
    state.textContent =
      ...
      (error.status === 503
        ? AT(
            " — администратору нужно подключить платёжный API.",
            " — an administrator needs to configure the payment API.",
          )
        : "");
  ...
  const labels =
    authLang() === "en"
      ? {
          ...
          files_create: "Create files",
          code: "Development",
          remote_ai: "Remote AI",
          advanced_exports: "Advanced export",
        }
      : {
          chat: "Чат",
          web: "Веб-поиск",
          ...
          code: "Разработка",
          remote_ai: "Удалённый AI",
          advanced_exports: "Расширенный экспорт",
        };
...
function renderUsage(snapshot) {
  ...
  const remote = snapshot.usage?.by_class?.PLATFORM_REMOTE || {
    total_tokens: 0,
  };
  const byok = snapshot.usage?.by_class?.BYOK || { total_tokens: 0 };
  const quota = snapshot.quota || {};
  const usageParts = [
    fill(T().usageLocal, { tokens: formatTokens(local.total_tokens) }),
  ];
  if (
    Number(remote.total_tokens || 0) ||
    quota.platform_remote_tokens_limit !== null
  ) {
    usageParts.push(
      fill(T().usageRemote, {
        used: formatTokens(remote.total_tokens),
        limit:
          quota.platform_remote_tokens_limit === null
            ? "∞"
            : formatTokens(quota.platform_remote_tokens_limit),
      }),
    );
  }
  if (Number(byok.total_tokens || 0))
    usageParts.push(
      fill(T().usageByok, { tokens: formatTokens(byok.total_tokens) }),
    );
...
function renderRequestBalance(snapshot) {
  ...
  if (
    ...
    state.textContent = AT(
      ...
      "Quota is active and renews with the billing period.",
    );
    state.className = "job-state completed";
  }
}
  ...
  if (!items.length) {
    host.append(
      Object.assign(document.createElement("p"), {
        className: "muted",
        textContent: T().topupHistoryEmpty,
      }),
    );
    return;
  }
  for (const item of items) {
    ...
    row.append(
      Object.assign(document.createElement("strong"), {
        textContent: `${Number(item.amount_rub || 0).toFixed(2)} ₽`,
      }),
      Object.assign(document.createElement("span"), {
        textContent: item.source || "yoomoney",
      }),
      Object.assign(document.createElement("span"), {
        textContent: item.status,
      }),
      Object.assign(document.createElement("span"), {
        textContent: `${new Date(Number(item.created_at || 0) * 1000).toLocaleString(authLang() === "en" ? "en-US" : "ru-RU")}${ref}${note}`,
      }),
    );
    host.append(row);
  }
...
function setupBillingActions() {
  ...
  if (themeCatalog) {
    ...
    if (!themes.length) {
      ...
      note.textContent = T().themesUnavailable;
      ...
      for (const theme of themes) {
        ...
        button.onclick = async () => {
          ...
          try {
            ...
            if (stateNode) {
              stateNode.textContent = `${T().themePurchased} ${formatRub(result.balance?.balance_rub)}`;
  ...
  $("#requestTopup").onclick = async () => {
    ...
    try {
      const result = await api("/api/billing/topup-requests", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          amount_rub: Number($("#topupAmountRub")?.value || 0),
          payment_reference: $("#topupPaymentReference")?.value || "",
      ...
      $("#topupNote").value = "";
      window.__billingSnapshot = {
        ...(window.__billingSnapshot || {}),
        topup_requests: [
          result.topup_request,
          ...(window.__billingSnapshot?.topup_requests || []),
        ],
      };
  ...
  $("#redeemPromoCode").onclick = async () => {
    ...
    try {
      const result = await api("/api/billing/promocodes/redeem", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
async function loadBilling() {
  ...
  $("#currentPlanPrice").textContent = plan.price_rub
    ? `${plan.price_rub} ₽/${AT("мес", "mo")}`
    : "0 ₽";
  ...
  toggle.onchange = async () => {
    try {
      await api("/api/billing/preferences", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ show_token_usage: toggle.checked }),
      });
    } catch (error) {
...
async function loadSessions() {
  ...
  try {
    ...
    const active = (result.sessions || []).filter(
      (s) => !s.revoked_at && Number(s.expires_at || 0) > Date.now() / 1000,
    );
    for (const item of active) {
      ...
      if (!item.current) {
        ...
        b.onclick = async () => {
          await api(`/api/auth/sessions/${item.id}/revoke`, {
            method: "POST",
            body: "{}",
          });
          await loadSessions();
...
function revealLink(link, kind = "recovery") {
  ...
  if (title)
    title.textContent =
      kind === "verify" ? T().verificationLinkTitle : T().recoveryLinkTitle;
  anchor.href = link;
...
function deliveryMessage(mode) {
  ...
  if (mode === "failed")
    return fill(T().emailDeliveryFailed, { support: supportEmail() });
  if (mode === "disabled")
    return fill(T().emailDeliveryDisabled, { support: supportEmail() });
...
async function loadTokenState(kind, token) {
  ...
  try {
    ...
    if (state.used_at) holder.textContent = T().tokenAlreadyUsed;
      ...
      holder.textContent =
        kind === "verify" ? T().tokenReadyVerify : T().tokenReadyReset;
...
async function init() {
  ...
  try {
    await Promise.all([
      ensureTurnstile(authForm, state),
      ensureTurnstile(requestVerificationForm, state),
    ]);
  } catch (_) {}
  $("#localeToggle")?.addEventListener("click", () =>
    applyAuthLanguage(authLang() === "en" ? "ru" : "en", state),
  );
  if (page === "register") {
    if (state.mode === "personal") {
      ...
      if (lead)
        lead.textContent = AT(
          "Сейчас включён локальный personal-профиль: регистрация не требуется. Для VPS/multi-user администратор включает режим аккаунтов.",
          "Local personal mode is enabled: registration is not required. For VPS/multi-user, an administrator enables accounts mode.",
        );
    ...
    authForm.onsubmit = async (event) => {
      ...
      hideRevealLink();
      try {
        const payload = authPayload(authForm, state, {
          display_name: $("#displayName").value,
          email: $("#email").value,
          password: $("#password").value,
        });
        if (authSecurity(state).turnstile_required && !payload.captcha_token)
        ...
        if (result.verification_required && result.status === "pending")
          success.textContent = T().registrationPendingBoth;
        else if (result.verification_required)
          success.textContent = T().registrationPendingVerify;
        else if (result.status === "pending")
          success.textContent = T().registrationPendingApproval;
        else {
          sessionStorage.setItem("par-tour-trigger", "1");
          success.textContent = AT(
        ...
        if (result.verification_url)
          revealLink(result.verification_url, "verify");
        else if (result.verification_required && result.email_delivery)
          success.textContent =
            `${success.textContent} ${deliveryMessage(result.email_delivery)}`.trim();
      } catch (exc) {
  ...
  if (page === "login") {
    if (state.mode === "personal") {
      success.textContent = AT(
        "Сейчас включён локальный personal-профиль: отдельный вход пользователю не требуется.",
        "Local personal mode is enabled: a separate user sign-in is not required.",
      );
      $("#authForm").hidden = true;
      return;
    }
  ...
  if (page === "forgot-password") {
    if (state.mode === "personal") {
      success.textContent = AT(
        "Сейчас включён локальный personal-профиль: отдельное восстановление пароля не требуется.",
        "Local personal mode is enabled: separate password recovery is not required.",
      );
      $("#authForm").hidden = true;
      return;
    }
    ...
    authForm.onsubmit = async (event) => {
      ...
      try {
        ...
        success.textContent =
          deliveryMessage(result.email_delivery) || T().resetReady;
  ...
  if (page === "verify-email") {
    ...
    if (!token) {
      ...
      requestVerificationForm.onsubmit = async (event) => {
        ...
        hideRevealLink();
        try {
          const payload = authPayload(requestVerificationForm, state, {
            email: $("#email").value,
          });
          if (authSecurity(state).turnstile_required && !payload.captcha_token)
            throw new Error(T().captchaRequired);
          const result = await api("/api/auth/verify-email/request", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(payload),
          });
          success.textContent =
            deliveryMessage(result.email_delivery) || T().verifyRequestDone;
          if (result.verification_url)
            revealLink(result.verification_url, "verify");
        } catch (exc) {
          error.textContent = exc.message;
      ...
      try {
        ...
        success.textContent =
          result.user?.status === "active"
            ? T().verifyDone
            : T().verifyPendingAdmin;
        if (result.user?.status === "active")
          sessionStorage.setItem("par-tour-trigger", "1");
        setTimeout(
          () =>
            (location.href = result.user?.status === "active" ? "/" : "/login"),
          700,
        );
      } catch (exc) {
        error.textContent = exc.message;
    ...
    if (state.user) {
      ...
      info.textContent =
        state.mode === "personal"
          ...
          : fill(T().profileInfoServer, {
              email: state.user.email || "",
              role: state.user.role || "USER",
              mode: profileModeLabel(state),
            });
      const verification = $("#accountVerification");
      if (verification) {
        verification.textContent = Number(state.user.email_verified || 0)
          ? T().emailVerified
          : T().emailUnverified;
      }
      try {
