# Personal Agent Rus v0.7.0 — Manual Acceptance Checklist
...
# 1. Обновление до v0.7.0

Распаковать содержимое v0.7.0 **поверх текущей рабочей папки Personal Agent Rus** с заменой файлов.
...
Это один из главных новых ручных тестов v0.7.0.
...
2. `REPAIR.cmd`
3. открыть UI и подтвердить `v0.7.0`
